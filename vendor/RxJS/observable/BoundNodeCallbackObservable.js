goog.module('rxjs$observable$BoundNodeCallbackObservable');
...
class BoundNodeCallbackObservable extends Observable_1.Observable {
    ...
    static create(callbackFunc, selector = undefined, scheduler) {
        return (...args) => {
            return new BoundNodeCallbackObservable(callbackFunc, /** @type {?} */ (selector), args, scheduler);
        };
    }
    /**
     * @param {?} subscriber
    ...
    static _tsickle_typeAnnotationsHelper() {
        ...
        /** @type {?} */
        BoundNodeCallbackObservable.prototype.callbackFunc;
        /** @type {?} */
        BoundNodeCallbackObservable.prototype.selector;
        /** @type {?} */
        BoundNodeCallbackObservable.prototype.args;
        /** @type {?} */
        BoundNodeCallbackObservable.prototype.scheduler;
    }
}
