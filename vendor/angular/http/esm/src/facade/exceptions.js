goog.module('_angular$http$src$facade$exceptions');
var base_wrapped_exception_1 = goog.require('_angular$http$src$facade$base__wrapped__exception');
var exception_handler_1 = goog.require('_angular$http$src$facade$exception__handler');
