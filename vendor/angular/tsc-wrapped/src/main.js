...
function main(project, cliOptions, codegen) {
    try {
        ...
        return codegen(ngOptions_1, cliOptions, program_1, host_1).then(function () {
            ...
            if (ngOptions_1.annotationsAs === 'static fields') {
                var downlevelHost = new compiler_host_1.DecoratorDownlevelCompilerHost(preprocessHost, programWithCodegen);
            ...
            if (!ngOptions_1.skipMetadataEmit) {
                ...
                var metadataWriter = new compiler_host_1.MetadataWriterHost(host_1, programWithCodegen, ngOptions_1);
                tsc_1.tsc.emit(createProgram_1(metadataWriter, programWithCodegen));
            }
        });
    }
    catch (e) {
