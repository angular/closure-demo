...
(function (global, factory) {
    ...
    var /** @type {?} */ INTERNAL_SERVER_PLATFORM_PROVIDERS = _angular_platformServer.__platform_server_private__.INTERNAL_SERVER_PLATFORM_PROVIDERS;
    var /** @type {?} */ SERVER_RENDER_PROVIDERS = _angular_platformServer.__platform_server_private__.SERVER_RENDER_PROVIDERS;
     ...
     */
    var /** @type {?} */ platformServerTesting = _angular_core.createPlatformFactory(_angular_compiler_testing.platformCoreDynamicTesting, 'serverTesting', INTERNAL_SERVER_PLATFORM_PROVIDERS);
    /**
    ...
    var ServerTestingModule = (function () {
        ...
        ServerTestingModule._tsickle_typeAnnotationsHelper = function () {
            /** @type {?} */
