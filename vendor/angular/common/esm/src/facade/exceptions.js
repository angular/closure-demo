goog.module('_angular$common$src$facade$exceptions');
var base_wrapped_exception_1 = goog.require('_angular$common$src$facade$base__wrapped__exception');
var exception_handler_1 = goog.require('_angular$common$src$facade$exception__handler');
