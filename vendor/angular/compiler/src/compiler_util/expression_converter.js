...
export var EventHandlerVars = (function () {
    ...
    EventHandlerVars._tsickle_typeAnnotationsHelper = function () {
        /** @type {?} */
...
export var ConvertPropertyBindingResult = (function () {
    ...
    ConvertPropertyBindingResult._tsickle_typeAnnotationsHelper = function () {
        /** @type {?} */
...
export var ConvertActionBindingResult = (function () {
    ...
    ConvertActionBindingResult._tsickle_typeAnnotationsHelper = function () {
        /** @type {?} */
...
/**
 *  Converts the given expression AST into an executable output AST, assuming the expression is used in an action binding (e.g. an event handler).
 * @param {?} builder
 * @param {?} nameResolver
 * @param {?} implicitReceiver
 * @param {?} action
...
/**
 *  Creates variables that are shared by multiple calls to `convertActionBinding` / `convertPropertyBinding`
 * @param {?} stmts
 * @return {?}
 */
...
var _AstToIrVisitor = (function () {
    ...
    _AstToIrVisitor._tsickle_typeAnnotationsHelper = function () {
        /** @type {?} */
