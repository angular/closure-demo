...
/**
 *  Expands special forms into elements. * For example, * ``` { messages.length, plural, =0 {zero} =1 {one} other {more than one} } ``` * will be expanded into * ``` <ng-container [ngPlural]="messages.length"> <template ngPluralCase="=0">zero</ng-container> <template ngPluralCase="=1">one</ng-container> <template ngPluralCase="other">more than one</ng-container> </ng-container> ```
 * @param {?} nodes
 * @return {?}
 */
...
export var ExpansionResult = (function () {
    ...
    ExpansionResult._tsickle_typeAnnotationsHelper = function () {
        /** @type {?} */
...
var _Expander = (function () {
    ...
    _Expander._tsickle_typeAnnotationsHelper = function () {
        /** @type {?} */
