...
export var ExtractionResult = (function () {
    ...
    ExtractionResult._tsickle_typeAnnotationsHelper = function () {
        /** @type {?} */
...
var _Visitor = (function () {
    ...
    /**
     *  Terminates a section. * If a section has only one significant children (comments not significant) then we should not keep the message from this children: * `<p i18n="meaning|description">{ICU message}</p>` would produce two messages: - one for the <p> content with meaning and description, - another one for the ICU message. * In this case the last message is discarded as it contains less information (the AST is otherwise identical). * Note that we should still keep messages extracted from attributes inside the section (ie in the ICU message here)
     * @param {?} node
    ...
    _Visitor._tsickle_typeAnnotationsHelper = function () {
        /** @type {?} */
