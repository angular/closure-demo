...
export var CompileMetadataResolver = (function () {
    ...
    /**
     *  Gets the metadata for the given directive. This assumes `loadNgModuleMetadata` has been called first.
     * @param {?} directiveType
     * @return {?}
     */
    ...
    /**
     *  Gets the metadata for the given module. This assumes `loadNgModuleMetadata` has been called first.
     * @param {?} moduleType
     * @return {?}
     */
    ...
    /**
     *  Loads an NgModule and all of its directives. This includes loading the exported directives of imported modules, but not private directives of imported modules.
     * @param {?} moduleType
     * @param {?} isSync
    ...
    /**
     *  Gets the metadata for the given pipe. This assumes `loadNgModuleMetadata` has been called first.
     * @param {?} pipeType
     * @return {?}
     */
    ...
    CompileMetadataResolver._tsickle_typeAnnotationsHelper = function () {
        /** @type {?} */
