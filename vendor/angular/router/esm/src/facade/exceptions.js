goog.module('_angular$router$src$facade$exceptions');
var base_wrapped_exception_1 = goog.require('_angular$router$src$facade$base__wrapped__exception');
var exception_handler_1 = goog.require('_angular$router$src$facade$exception__handler');
