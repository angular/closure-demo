goog.module('_angular$core$src$zone$ng__zone');
var async_1 = goog.require('_angular$core$src$facade$async');
var ng_zone_impl_1 = goog.require('_angular$core$src$zone$ng__zone__impl');
var exceptions_1 = goog.require('_angular$core$src$facade$exceptions');
var ng_zone_impl_2 = ng_zone_impl_1;
...
class NgZone {
     ...
     * @return {?}
     */
    static isInAngularZone() { return ng_zone_impl_1.NgZoneImpl.isInAngularZone(); }
    /**
     * @return {?}
     */
